...
/**
 * @class Ext2.Container
 * @extends Ext2.BoxComponent
 * <p>Base class for any {@link Ext2.BoxComponent} that can contain other components. The most commonly
 * used Container classes are {@link Ext2.Panel}, {@link Ext2.Window} and {@link Ext2.TabPanel}, but you can
 * create a lightweight Container to encapsulate an HTML element that is created to your
 * specifications at render time by using the {@link Ext2.Component#autoEl autoEl} config option
 * which takes the form of a {@link Ext2.DomHelper DomHelper} specification. If you do not need
 * the capabilities offered by the above mentioned classes, for instance embedded
 * {@link Ext2.layout.ColumnLayout column} layouts inside FormPanels, then this is a useful technique.</p>
...
var embeddedColumns = new Ext2.Container({
    autoEl: {},
    layout: 'column',
    defaults: {
        xtype: 'container',
 ...
 * <p>By default, Containers use the {@link Ext2.layout.ContainerLayout ContainerLayout} scheme. This simply renders
 ...
 * <p>Below is an example of adding a newly created GridPanel to a TabPanel. A TabPanel uses {@link Ext2.layout.CardLayout}
 * as its layout manager which means all its child items are sized to fit exactly into its client area. The following
 * code requires prior knowledge of how to create GridPanels. See {@link Ext2.grid.GridPanel}, {@link Ext2.data.Store}
 * and {@link Ext2.data.JsonReader} as well as the grid examples in the Ext2 installation's <tt>examples/grid</tt>
 * directory.</p><pre><code>
//  Create the GridPanel.
myGrid = new Ext2.grid.GridPanel({
    store: myStore,
 ...
 */
Ext2.Container = Ext2.extend(Ext2.BoxComponent, {
    ...
    /**
     * @cfg {String} layout
     * The layout type to be used in this container.  If not specified, a default {@link Ext2.layout.ContainerLayout}
     ...
     * <li>{@link Ext2.layout.Absolute}</li>
     * <li>{@link Ext2.layout.Accordion}</li>
     * <li>{@link Ext2.layout.AnchorLayout}</li>
     * <li>{@link Ext2.layout.BorderLayout}</li>
     * <li>{@link Ext2.layout.CardLayout}</li>
     * <li>{@link Ext2.layout.ColumnLayout}</li>
     * <li>{@link Ext2.layout.FitLayout}</li>
     * <li>{@link Ext2.layout.FormLayout}</li>
     * <li>{@link Ext2.layout.TableLayout}</li></ul>
     */
    /**
     ...
     * items one at a time (like {@link Ext2.layout.Accordion}, {@link Ext2.layout.CardLayout} and
     * {@link Ext2.layout.FitLayout}).  Related to {@link Ext2.layout.ContainerLayout#activeItem}.
     */
    /**
     * @cfg {Mixed} items
     * A single item, or an array of child Components to be added to this container.
     * Each item can be any type of object based on {@link Ext2.Component}.<br><br>
     ...
     * "lazy instantiation", set the {@link Ext2.Component#xtype} config property to
     * the registered type of the Component wanted.<br><br>
     * For a list of all available xtypes, see {@link Ext2.Component}.
     ...
     * contained {@link Ext2.Panel} items, you could pass: defaults: {bodyStyle:'padding:15px'}.
     */
     ...
     * <p>The default {@link Ext2.Component xtype} of child Components to create in this Container when
    ...
    initComponent : function(){
        ...
        this.addEvents(
             ...
             * @param {Ext2.Container} this
             * @param {ContainerLayout} layout The ContainerLayout implementation for this container
             */
            'afterlayout',
            /**
             * @event beforeadd
             * Fires before any {@link Ext2.Component} is added or inserted into the container.
             * A handler can return false to cancel the add.
             * @param {Ext2.Container} this
             * @param {Ext2.Component} component The component being added
             * @param {Number} index The index at which the component will be added to the container's items collection
             */
            'beforeadd',
            /**
             * @event beforeremove
             * Fires before any {@link Ext2.Component} is removed from the container.  A handler can return
             * false to cancel the remove.
             * @param {Ext2.Container} this
             * @param {Ext2.Component} component The component being removed
             */
            'beforeremove',
            /**
             * @event add
             * Fires after any {@link Ext2.Component} is added or inserted into the container.
             * @param {Ext2.Container} this
             * @param {Ext2.Component} component The component that was added
             * @param {Number} index The index at which the component was added to the container's items collection
             */
            'add',
            /**
             * @event remove
             * Fires after any {@link Ext2.Component} is removed from the container.
             * @param {Ext2.Container} this
             * @param {Ext2.Component} component The component that was removed
             */
            'remove'
        );

        /**
         * The collection of components in this container as a {@link Ext2.util.MixedCollection}
    ...
    initItems : function(){
        if(!this.items){
            this.items = new Ext2.util.MixedCollection(false, this.getComponentId);
    ...
    // private
    render : function(){
        Ext2.Container.superclass.render.apply(this, arguments);
        if(this.layout){
            if(typeof this.layout == 'string'){
                this.layout = new Ext2.Container.LAYOUTS[this.layout.toLowerCase()](this.layoutConfig);
            }
        ...
        if(this.monitorResize === true){
            Ext2.EventManager.onWindowResize(this.doLayout, this, [false]);
        }
    },
     ...
     * @return {Ext2.Element} The Element to render child Components into.
     */
    ...
    /**
     * <p>Adds a {@link Ext2.Component Component} to this Container. Fires the {@link #beforeadd} event before
     ...
     * @param {Ext2.Component/Object} component The Component to add.<br><br>
     * Ext2 uses lazy rendering, and will only render the added Component should
     ...
     * The type of Component created from a config object is determined by the {@link Ext2.Component#xtype xtype}
     * config property. If no xtype is configured, the Container's {@link #defaultType}
     * is used.<br><br>
     * For a list of all available xtypes, see {@link Ext2.Component}.
     * @return {Ext2.Component} component The Component (or config object) that was
     * added with the Container's default config values applied.
     * <p>example:</p><pre><code>
var myNewGrid = new Ext2.grid.GridPanel({
    store: myStore,
    colModel: myColModel
});
...
myTabPanel.setActiveTab(myNewGrid);
     ...
     * @param {Ext2.Component} component The child Component to insert.<br><br>
     * Ext2 uses lazy rendering, and will only render the inserted Component should
     * it become necessary.<br><br>
     * A Component config object may be passed in order to avoid the overhead of
     * constructing a real Component object if lazy rendering might mean that the
     * inserted Component will not be rendered immediately. To take advantage of
     * this "lazy instantiation", set the {@link Ext2.Component#xtype} config
    ...
    applyDefaults : function(c){
        if(this.defaults){
            if(typeof c == 'string'){
                c = Ext2.ComponentMgr.get(c);
                Ext2.apply(c, this.defaults);
            }else if(!c.events){
                Ext2.applyIf(c, this.defaults);
            }else{
                Ext2.apply(c, this.defaults);
            }
        }
     ...
     * @param {Boolean} autoDestroy (optional) True to automatically invoke the removed Component's {@link Ext2.Component#destroy} function.
     * Defaults to the value of this Container's {@link #autoDestroy} config.
     * @return {Ext2.Component} component The Component that was removed.
     */
    ...
    lookupComponent : function(comp){
        if(typeof comp == 'string'){
            return Ext2.ComponentMgr.get(comp);
        }else if(!comp.events){
    ...
    createComponent : function(config){
        return Ext2.ComponentMgr.create(config, this.defaultType);
    },
     ...
     * set, a default {@link Ext2.layout.ContainerLayout} will be created and set as the container's layout.
     * @return {ContainerLayout} layout The container's layout
     */
    getLayout : function(){
        if(!this.layout){
            var layout = new Ext2.layout.ContainerLayout(this.layoutConfig);
    ...
    beforeDestroy : function(){
        ...
        Ext2.Container.superclass.beforeDestroy.call(this);
    },
     ...
     * @return {Array} Array of Ext2.Components
     */
...
Ext2.Container.LAYOUTS = {};
Ext2.reg('container', Ext2.Container);
