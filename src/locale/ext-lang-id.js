...
Ext2.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Pemuatan...</div>';
...
if(Ext2.grid.GridPanel){
  Ext2.grid.GridPanel.prototype.ddText = "{0} selected row(s)";
  Ext2.grid.GridPanel.prototype.ddText = "{0} baris terpilih";
}

if(Ext2.TabPanelItem){
  Ext2.TabPanelItem.prototype.closeText = "Close this tab";
  Ext2.TabPanelItem.prototype.closeText = "Tutup tab ini";
}

if(Ext2.form.Field){
  Ext2.form.Field.prototype.invalidText = "The value in this field is invalid";
  Ext2.form.Field.prototype.invalidText = "Isian belum benar";
}

if(Ext2.LoadMask){
  Ext2.LoadMask.prototype.msg = "Loading...";
  Ext2.LoadMask.prototype.msg = "Pemuatan...";
}
