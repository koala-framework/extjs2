...
Ext2.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">加载中...</div>';
...
if(Ext2.grid.GridPanel){
   Ext2.grid.GridPanel.prototype.ddText = "{0} 选择行";
}

if(Ext2.TabPanelItem){
   Ext2.TabPanelItem.prototype.closeText = "关闭";
}

if(Ext2.form.Field){
   Ext2.form.Field.prototype.invalidText = "输入值非法";
}
