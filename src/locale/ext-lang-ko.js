...
Ext2.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">로딩중...</div>';
...
if(Ext2.grid.GridPanel){
   Ext2.grid.GridPanel.prototype.ddText = "{0} 개가 선택되었습니다.";
}

if(Ext2.TabPanelItem){
   Ext2.TabPanelItem.prototype.closeText = "닫기";
}

if(Ext2.form.Field){
   Ext2.form.Field.prototype.invalidText = "올바른 값이 아닙니다.";
}

if(Ext2.LoadMask){
    Ext2.LoadMask.prototype.msg = "로딩중...";
}
